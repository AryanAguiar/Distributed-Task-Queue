...
Revision ID: d72b126b0f96
Revises: 
Create Date: 2026-04-22 12:17:43.106481
...
def upgrade() -> None:
    ...
    sa.Column('trigger', sa.Enum('manual', 'on_resolve', 'on_open', name='trigger'), nullable=False),
    sa.Column('created_at', sa.DateTime(timezone=True), server_default=sa.text('now()'), nullable=True),
    sa.Column('updated_at', sa.DateTime(timezone=True), nullable=True),
